...
*   **Density-Aware Scaling:** Ensures consistent pixel density across your entire batch (1170px to 3200px steps).
    *(Đảm bảo mật độ điểm ảnh đồng nhất cho toàn bộ batch theo dải mốc từ 1170px đến 3200px.)*
